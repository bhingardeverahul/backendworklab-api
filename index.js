...
app.post('/signup',upload,async(req, res) => {
  ...
  try {
    ...
    const mailOptions = {
        ...
        html:`<p>Hii ${user.name}, please click here to <a href=https://6507fcb725bea33b429fd556--enchanting-brigadeiros-156eef.netlify.app/verify/${token}> Verify </a> your mail.</p>`
    }
  ...
  .then(user => {
      ...
      var transporter = nodemailer.createTransport({
        ...
        var mailOptions = {
          ...
          html: `<p>Hii ${user.name},Please click here to <a href=https://6507fcb725bea33b429fd556--enchanting-brigadeiros-156eef.netlify.app/resetpassword/${user.id}/${token}> Verify </a> your mail.</p>`
        };
...
try {
  ...
  const mailOptions = {
      ...
      html:`<p>Hii ${userData.name}, please click here to <a href=https://6507fcb725bea33b429fd556--enchanting-brigadeiros-156eef.netlify.app/verify?${userData._id}> Verify </a> your mail.</p>`
  }
  transporter.sendMail(mailOptions, function(error,info){
      if(error){
          console.log(error);
